      ...
      <div className="p-8">
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 text-2xl text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
              {icon}
            </div>
            <div>
        ...
        <p className="text-slate-600 leading-7 mb-6 group-hover:text-slate-700 transition-colors duration-200">
          {description}
        </p>
